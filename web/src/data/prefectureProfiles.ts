...
export const prefectureProfiles: PrefectureProfile[] = [
  ...
  { name: "滋賀", region: "関西", focusVenues: ["ラピュタボウル彦根", "ボウル滋賀"] },
  { name: "京都", region: "関西", focusVenues: ["キョーイチボウル宇治", "MKボウル上賀茂"] },
  { name: "大阪", region: "関西", focusVenues: ["心斎橋サンボウル", "マグスミノエ", "ラウンドワンスタジアム堺中央環状店"] },
